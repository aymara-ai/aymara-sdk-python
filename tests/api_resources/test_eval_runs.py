...
class TestEvalRuns:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_responses(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_responses_with_all_params(self, client: Aymara) -> None:
        eval_run = client.eval_runs.get_responses(
            eval_run_uuid="eval_run_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_responses(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_get_responses(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_get_responses(self, client: Aymara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `eval_run_uuid` but received ''"):
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_run_score(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_run_score_with_all_params(self, client: Aymara) -> None:
        eval_run = client.eval_runs.run_score(
            eval_uuid="eval_uuid",
            responses=[
                {
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_run_score(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_run_score(self, client: Aymara) -> None:
...
class TestAsyncEvalRuns:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_responses(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_responses_with_all_params(self, async_client: AsyncAymara) -> None:
        eval_run = await async_client.eval_runs.get_responses(
            eval_run_uuid="eval_run_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_responses(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_get_responses(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_get_responses(self, async_client: AsyncAymara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `eval_run_uuid` but received ''"):
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_run_score(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_run_score_with_all_params(self, async_client: AsyncAymara) -> None:
        eval_run = await async_client.eval_runs.run_score(
            eval_uuid="eval_uuid",
            responses=[
                {
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_run_score(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_run_score(self, async_client: AsyncAymara) -> None:
