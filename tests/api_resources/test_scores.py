...
class TestScores:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_answers(self, client: AymaraAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_answers_with_all_params(self, client: AymaraAI) -> None:
        score = client.scores.get_answers(
            score_run_uuid="score_run_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_answers(self, client: AymaraAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_get_answers(self, client: AymaraAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_get_answers(self, client: AymaraAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `score_run_uuid` but received ''"):
...
class TestAsyncScores:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_answers(self, async_client: AsyncAymaraAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_answers_with_all_params(self, async_client: AsyncAymaraAI) -> None:
        score = await async_client.scores.get_answers(
            score_run_uuid="score_run_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_answers(self, async_client: AsyncAymaraAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_get_answers(self, async_client: AsyncAymaraAI) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_get_answers(self, async_client: AsyncAymaraAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `score_run_uuid` but received ''"):
