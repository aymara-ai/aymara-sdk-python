...
class TestTests:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_questions(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_questions_with_all_params(self, client: Aymara) -> None:
        test = client.tests.retrieve_questions(
            test_uuid="test_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_questions(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_questions(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_retrieve_questions(self, client: Aymara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `test_uuid` but received ''"):
...
class TestAsyncTests:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_questions(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_questions_with_all_params(self, async_client: AsyncAymara) -> None:
        test = await async_client.tests.retrieve_questions(
            test_uuid="test_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_questions(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_questions(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_retrieve_questions(self, async_client: AsyncAymara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `test_uuid` but received ''"):
