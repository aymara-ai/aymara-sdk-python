...
class TestEvals:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_prompts(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_prompts_with_all_params(self, client: Aymara) -> None:
        eval = client.evals.get_prompts(
            eval_uuid="eval_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_prompts(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_get_prompts(self, client: Aymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_get_prompts(self, client: Aymara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `eval_uuid` but received ''"):
...
class TestAsyncEvals:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_prompts(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_prompts_with_all_params(self, async_client: AsyncAymara) -> None:
        eval = await async_client.evals.get_prompts(
            eval_uuid="eval_uuid",
            limit=1,
            offset=0,
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_prompts(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_get_prompts(self, async_client: AsyncAymara) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_get_prompts(self, async_client: AsyncAymara) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `eval_uuid` but received ''"):
