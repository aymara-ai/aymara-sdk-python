...
class TestEvals:
    ...
    def test_method_continue_run(self, client: AymaraAI) -> None:
        ...
        assert_matches_type(EvalRunResult, eval, path=["response"])
    ...
    def test_method_list_responses(self, client: AymaraAI) -> None:
        eval = client.evals.list_responses(
            eval_run_uuid="eval_run_uuid",
        )
        assert_matches_type(SyncOffsetPage[EvalListResponsesResponse], eval, path=["response"])
    ...
    def test_raw_response_list_responses(self, client: AymaraAI) -> None:
        response = client.evals.with_raw_response.list_responses(
            eval_run_uuid="eval_run_uuid",
        )
    ...
    def test_streaming_response_list_responses(self, client: AymaraAI) -> None:
        with client.evals.with_streaming_response.list_responses(
            eval_run_uuid="eval_run_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list_responses(self, client: AymaraAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `eval_run_uuid` but received ''"):
            client.evals.with_raw_response.list_responses(
                eval_run_uuid="",
            )
    ...
    def test_method_list_runs(self, client: AymaraAI) -> None:
        ...
        assert_matches_type(SyncOffsetPage[EvalRunResult], eval, path=["response"])
...
class TestAsyncEvals:
    ...
    async def test_method_list_responses(self, async_client: AsyncAymaraAI) -> None:
        eval = await async_client.evals.list_responses(
            eval_run_uuid="eval_run_uuid",
        )
        assert_matches_type(AsyncOffsetPage[EvalListResponsesResponse], eval, path=["response"])
    ...
    async def test_raw_response_list_responses(self, async_client: AsyncAymaraAI) -> None:
        response = await async_client.evals.with_raw_response.list_responses(
            eval_run_uuid="eval_run_uuid",
        )
    ...
    async def test_streaming_response_list_responses(self, async_client: AsyncAymaraAI) -> None:
        async with async_client.evals.with_streaming_response.list_responses(
            eval_run_uuid="eval_run_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_responses(self, async_client: AsyncAymaraAI) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `eval_run_uuid` but received ''"):
            await async_client.evals.with_raw_response.list_responses(
                eval_run_uuid="",
            )
    ...
    async def test_method_list_runs(self, async_client: AsyncAymaraAI) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[EvalRunResult], eval, path=["response"])
