...
from ...types.eval_runs import image_get_presigned_urls_params
from ...types.answer_in_param import AnswerInParam
from ...types.eval_runs.image_get_presigned_urls_response import ImageGetPresignedURLsResponse
...
class ImageResource(SyncAPIResource):
    ...
    def get_presigned_urls(
        ...
        *,
        ...
        """
        Generate presigned URLs for image uploads, keyed by prompt UUID.

        This function delegates to the get_image_presigned_urls function.
        ...
        """
        return self._post(
            "/v2/eval-runs/image/get-presigned-urls",
